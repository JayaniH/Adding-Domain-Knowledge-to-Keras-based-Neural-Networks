...
def train_model(train_i, test_i, i):
    ...
    outfile = open("../../models/springboot2/new_model/xgb_" + str(i+1) + ".pkl", "wb")
...
def evaluate_model(train_i, test_i, i):
    ...
    infile = open("../../models/springboot2/new_model/xgb_" + str(i+1) + ".pkl", "rb")
...
def predict(i, x):
    infile = open("../../models/springboot2/8_xgb/xgb_" + str(i+1) + ".pkl", "rb")
