...
def train_model(train_i, test_i, i):
    ...
    outfile = open("../../models/springboot/new_model/" + str(i+1) + ".pkl", "wb")
...
def evaluate_model(train_i, test_i, i):
    ...
    infile = open("../../models/springboot/new_model/" + str(i+1) + ".pkl", "rb")
...
def predict(i, x):
    infile = open("../../models/springboot/7_linear_regression/" + str(i + 1) + ".pkl", "rb")
    model = pkl.load(infile)
    infile.close()
