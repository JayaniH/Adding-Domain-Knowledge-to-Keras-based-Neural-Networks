...
def train_model(train_i, test_i, i):
    ...
    # save scaler X
    outfile = open('../../models/ballerina/new_model/_scalars/scalerX_' + str(i+1) +'.pkl', 'wb')
...
def evaluate_model(train_i, test_i, i):
    ...
    infile = open('../../models/ballerina/new_model/_scalars/scalerX_' + str(i+1) +'.pkl', 'rb')
    ...
    model = keras.models.load_model('../../models/ballerina/new_model/K' + str(i+1), compile=False)
...
def save_predictions_to_csv(i, df, residual_prediction, latency_prediction):
    ...
    # print(results_df)
    results_df.to_csv('../../models/ballerina/new_model/results/K' + str(i+1) + '.csv', sep=",", index= False)
