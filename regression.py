...
def train_models():
    ...
    for name, group in df:
        ...
        outfile = open("../models/12_regression_epoch200_batch4_rmse_ouliers_removed_unscaledY/_scalars/scaler_" + name.replace("/", "_") + ".pkl", "wb")
        ...
        # save model
        model.save('../models/12_regression_epoch200_batch4_rmse_ouliers_removed_unscaledY/' + name.replace("/", "_"))
