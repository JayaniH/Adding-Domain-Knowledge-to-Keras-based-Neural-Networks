...
def train_models():
    ...
    for name, group in df:
        ...
        # save scaler X
        outfile = open("../models/13_regression_with_custom_loss/_scalars/scalerX" + name.replace("/", "_") + ".pkl", "wb")
        ...
        # save model
        model.save('../models/13_regression_with_custom_loss/' + name.replace("/", "_"))
